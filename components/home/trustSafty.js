...
const TrustAndSafety = () => {
  ...
  const trustPillars = [
    {
      ...
      description:
        "End-to-end encryption for all communications and data with regular security audits",
    ...
    },
    {
      ...
      description:
        "All payments securely held in escrow until work is completed and approved",
    ...
    },
    {
      ...
      description:
        "Rigorous verification process for all skill providers on our platform",
      color: "bg-green-600",
    },
  ];
  ...
  const verificationSteps = [
    {
      ...
      description:
        "We verify the identity of all users through official ID and facial recognition",
    },
    {
      icon: <FileCheck className="w-6 h-6 text-purple-primary" />,
      title: "Skill Certification",
      description:
        "Providers submit proof of their skills and qualifications for review",
    },
    {
      icon: <CheckCircle className="w-6 h-6 text-purple-primary" />,
      title: "Trust Score",
      description:
        "Ongoing rating system based on client feedback and successful projects",
    },
  ];
  ...
  const paymentFeatures = [
    ...
    },
    {
      ...
      description:
        "Break large projects into smaller, manageable payment milestones",
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Your security is our priority. We've built robust systems to ensure
            safe transactions between local providers and seekers everywhere.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-6  mb-16 md:mb-20">
          {trustPillars.map((pillar, index) => (
            ...
            >
              <div
                className={`${pillar.color} p-4 flex items-center justify-center`}
              >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20 border-t border-blue-primary/10 pt-3">
          <motion.div
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              Our escrow payment system ensures that funds are only released
              when work is completed to satisfaction, protecting both providers
              and clients.
            </p>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="bg-white rounded-2xl shadow-lg p-6 max-w-xs w-full">
                  ...
                  <p className="text-xs text-gray-500 text-center">
                    Funds are secure and will be released when both parties
                    agree the work is complete
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mb-20">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We take multiple steps to verify all users on our platform,
              ensuring a safe and trustworthy community.
            </p>
          </motion.div>
          ...
          <div className="md:flex items-center">
            ...
            <div className="md:w-3/4 md:pl-8">
              <h3 className="text-2xl font-bold mb-3 font-display">
                The Joblad Trust Badge
              </h3>
              <p className="text-gray-600 mb-4">
                Look for the Trust Badge on provider profiles. This indicates
                they've passed our thorough verification process and have
              ...
              <div className="flex items-start mt-4">
                ...
                <p className="text-sm text-gray-600">
                  Always check for the Trust Badge before hiring, and never take
                  communications or payments outside of the Joblad platform for
                  your safety.
                </p>
              </div>
            </div>
